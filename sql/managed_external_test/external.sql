...
FROM customer_external c
JOIN transaction_external t ON c.customer_id = t.customer_id
...
FROM transaction_external t
JOIN customer_external c ON t.customer_id = c.customer_id
GROUP BY SUBSTR(t.transaction_date, 4, 2), c.job_industry_category;

SELECT c.first_name, c.last_name
FROM customer_external c
LEFT JOIN transaction_external t ON c.customer_id = t.customer_id
